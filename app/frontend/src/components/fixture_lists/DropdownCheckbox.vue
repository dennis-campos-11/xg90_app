      ...
      <div class="p-3">
        <div class="relative">
          ...
          <input v-model="search" type="text" :placeholder="searchPlaceholder"
            class="block w-full p-2 ps-10 text-sm border-0 rounded-lg bg-gray-100 focus-visible:ring-blue-500 dark:bg-neutral-700 dark:placeholder-neutral-400 dark:focus-visible:ring-blue-500" />
        </div>
      </div>
