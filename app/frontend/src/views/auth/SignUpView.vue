      ...
      <form class="space-y-6" @submit.prevent="handleSignUp">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div v-if="errors?.value?.first_name" class="text-red-500 text-sm">
          ...
          <div>
            ...
            <div v-if="errors?.value?.last_name" class="text-red-500 text-sm">
        ...
        <div>
          ...
          <div v-if="errors?.value?.email" class="text-red-500 text-sm">
